...
namespace Data.Migrations
{
    ...
    [Migration("20210530123106_RemovetechnicalsIds")]
    partial class RemovetechnicalsIds
    {
            ...
            modelBuilder.Entity("Domain.Entities.Line", b =>
                {
                    ...
                    b.Property<int?>("SourceFlaggedActorId")
                        .HasColumnType("integer");

                    b.Property<int?>("TargetFlaggedActorId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ReportId", "SourceFlaggedActorId");

                    b.HasIndex("ReportId", "TargetFlaggedActorId");
            ...
            modelBuilder.Entity("Domain.Entities.FlaggedActor", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Actor", "Actor")
                        ...
                        .HasForeignKey("ReportId", "ActorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
